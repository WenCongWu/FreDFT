...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./weights/FreDFT_FLIR.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='./data/multispectral/FLIR.yaml', help='*.data path')
    ...
    p = "/home/F/wwc/PythonProjects/FreDFT/dataset/FLIR-align-3class/labels/test"
    labels_list = os.listdir(p)
    labels_list.sort()
    if opt.data in ['./data/multispectral/FLIR.yaml', './data/multispectral/FLIR-ADAS.yaml', './data/multispectral/VEDAI.yaml']:
        opt.verbose = True
