...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5l_FDFT_FLIR.yaml', help='model.yaml path')
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ...
        # 2024/10/27 wwc 修改
        #ckpt = opt.resume if isinstance(opt.resume, str) else get_latest_run('/home/Newdisk/wwc/PythonProjects/IDSFormer_yolov5/runs/train/exp2')  # specified or most recent path
    ...
    # Evolve hyperparameters (optional)
        ...
        for _ in range(300):  # generations to evolve
            ...
            results = train_rgb_ir(hyp.copy(), opt, device) # 2024/10/16 wwc 修改
